...
class _CardsView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Cuando tenemos mas contenido y no es una lista, podemos hacer scroll con esto
...
class _CardType4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      // Evita que los hijos se salgan del padre, el hardEdge
      clipBehavior: Clip.hardEdge,
      elevation: elevation,
      child: Stack(
        children: [
          Image.network('https://picsum.photos/id/${elevation.toInt()}/600/500',
